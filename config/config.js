...
export const DATABASEDB = process.env.DATABASEDB || "testdb";

/* export const HOSTSERVER = process.env.HOSTSERVER;
export const PORTSERVER = process.env.PORTSERVER || 3000; */
